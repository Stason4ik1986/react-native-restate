...
import { Text, View, Image, Platform, FlatList, ScrollView, Dimensions, TouchableOpacity } from 'react-native';
          ...
          <View className="w-full border-t border-primary-200 pt-7 mt-5">
            ...
            <View className="flex flex-row items-center justify-between mt-4">
              <View className="flex flex-row items-center">
                <Image source={{ uri: property?.agents.avatar }} className="size-14 rounded-full" />

                <View className="flex flex-col items-start justify-center ml-3">
                  <Text className="text-lg text-black-300 text-start font-rubik-bold">{property?.agents.name}</Text>
                  <Text className="text-sm text-black-200 text-start font-rubik-medium">{property?.agents.email}</Text>
                </View>
              </View>
